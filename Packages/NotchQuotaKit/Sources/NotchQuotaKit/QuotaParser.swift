...
/// Pure parsing, ported unchanged from the macOS app so both platforms agree on
/// what a reading means. Unknown, genuinely zero and full quota stay distinct.
public enum QuotaParser {
    ...
    public static func percent(_ value: Any?, fraction: Bool = false, used: Bool = false) -> Double? {
    ...
    public static func codex(_ data: [String: Any]) -> Snapshot {
    ...
    public static func claude(_ data: [String: Any]) -> Snapshot {
    ...
    public static func antigravity(_ data: [String: Any]) -> Snapshot {
        var rows: [QuotaWindow] = []
